...
export default function Regist(props) {
  ...
  const onClickRegist = () => {
    ...
    if (!passwordCheck) return alert("비밀번호 확인란은 입력사항 입니다.");
    ...
    if (password !== passwordCheck)
      return alert("비밀번호 확인의 값이 동일하지 않습니다.");
    ...
    if (!email.match(regExp)) return alert("이메일 형식이 올바르지 않습니다");

    const params = { userid, password, email, year, month, day, gender };
    console.log(params)
